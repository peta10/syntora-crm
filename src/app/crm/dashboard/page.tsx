  ...
  return (
    <Card className="bg-gray-900/50 border-gray-700/50">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <div className="w-8 h-8 bg-gradient-to-br from-[#6E86FF]/20 to-[#FF6BBA]/20 rounded-lg flex items-center justify-center">
          {icon}
        </div>
      </CardHeader>
      <CardContent>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            <button className="bg-gradient-to-r from-[#6E86FF] to-[#FF6BBA] text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all">
              Quick Actions
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="bg-gray-900/50 border-gray-700/50">
            <CardHeader>
              <CardTitle className="text-white flex items-center">
                <BarChart3 className="w-5 h-5 mr-2 text-[#6E86FF]" />
                Revenue Trend
              </CardTitle>
              ...
              <div className="h-64 flex items-end justify-between space-x-2">
                {metrics.revenueHistory.map((item, index) => (
                  <div key={item.month} className="flex flex-col items-center space-y-2">
                    <div 
                      className="bg-gradient-to-t from-[#6E86FF] to-[#FF6BBA] rounded-t-sm"
                      style={{ 
          ...
          <Card className="bg-gray-900/50 border-gray-700/50">
            <CardHeader>
              <CardTitle className="text-white flex items-center">
                <Target className="w-5 h-5 mr-2 text-[#FF6BBA]" />
                Sales Pipeline
              </CardTitle>
              <CardDescription className="text-gray-400">
                Deals by stage
                ...
                {metrics.pipelineData.map((stage, index) => (
                  <div key={stage.stage} className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-medium text-white">{stage.count} deals</div>
                      <div className="text-xs text-gray-400">${stage.value.toLocaleString()}</div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Recent Activities */}
          <Card className="lg:col-span-2 bg-gray-900/50 border-gray-700/50">
            <CardHeader>
        ...
        <div className="mt-8">
          <Card className="bg-gray-900/50 border-gray-700/50">
            <CardHeader>
              <CardTitle className="text-white flex items-center">
                <Users className="w-5 h-5 mr-2 text-[#6E86FF]" />
                Contact Insights
              </CardTitle>
              <CardDescription className="text-gray-400">
